...
public class AR04Ctr {
	...
	@PutMapping(value = "/updateBilgCancelIntra")
    public String updateBilgCancelIntra(@RequestBody Map<String, Object> paramMap, ModelMap model) {
    	int result = ar04Svc.updateBilgCancelIntra(paramMap);
    	if(result == 0) {
			model.addAttribute("resultCode", 500);
			model.addAttribute("resultMessage", messageUtils.getMessage("taxComplete"));
		} else {
	...
	@PostMapping(value = "/deleteNoSndTaxHd")
	public String deleteNoSndTaxHd(@RequestBody Map<String, Object> paramMap, ModelMap model) {
		try {
			ar04Svc.deleteNoSndTaxHd(paramMap);
			model.addAttribute("resultCode", 200);
			model.addAttribute("resultMessage", messageUtils.getMessage("delete"));
		}catch(Exception e){
			model.addAttribute("resultCode", 500);
